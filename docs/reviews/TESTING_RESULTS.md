...
**Проблема:** Отображался "0" для специалистов без отзывов из-за неправильной проверки `averageRating`  
**Решение:** Исправлены условия рендеринга в `SpecialistHero` и проверка в `RatingDisplay`  
