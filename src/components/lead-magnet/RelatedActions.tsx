...
interface RelatedActionsProps {
  ...
  currentLeadMagnetType?: 'file' | 'link' | 'service'
}
...
export function RelatedActions({ 
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Призыв к консультации (только для файлов и ссылок, не для услуг) */}
      {currentLeadMagnetType !== 'service' && (
        <motion.section
