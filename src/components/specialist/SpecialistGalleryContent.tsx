/**
 * Базовый компонент галереи без заголовка и обертки
...
export interface SpecialistGalleryContentProps {
  items: GalleryItem[]
}

export function SpecialistGalleryContent({ items }: SpecialistGalleryContentProps) {
