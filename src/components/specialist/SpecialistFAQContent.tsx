/**
 * Базовый компонент FAQ без заголовка и обертки
...
export interface SpecialistFAQContentProps {
  faqs: FAQ[]
}

export function SpecialistFAQContent({ faqs }: SpecialistFAQContentProps) {
